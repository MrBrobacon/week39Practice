...
console.log("Difference", differans);
/* -----------------------------------------------------------------------------
    Task: D
...
/* -----------------------------------------------------------------------------
    Task: E
    Create a function named "multiplier." This function should take (as a parameter) a list of numbers.
    The function should return the product of the numbers (i.e., tal1 * tal2 * tal3 * ... and so on).
*/
console.log("Task: E");
const numbers = [2, 3, 4, 5];
const result = multiplier(numbers);
console.log("Product:", result);

function multiplier(liste) {
    let product = 1;
